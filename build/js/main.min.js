...
/* harmony import */ var _modules_video_video__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/video/video */ "./js/modules/video/video.js");
...
/* harmony import */ var _modules_slider_init_sliders__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/slider/init-sliders */ "./js/modules/slider/init-sliders.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    var video = new _modules_video_video__WEBPACK_IMPORTED_MODULE_1__["Video"]();
    video.init();
    var tabs = new _modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_2__["Tabs"]();
    window.tabs = tabs;
    Object(_modules_slider_init_sliders__WEBPACK_IMPORTED_MODULE_3__["initSliders"])();
...
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./slider */ "./js/modules/slider/slider.js");

var initSliders = function initSliders() {
  var sliders = document.querySelectorAll('[data-slider="root"]');
  sliders.forEach(function (slider) {
    var newSlider = new _slider__WEBPACK_IMPORTED_MODULE_0__["Slider"](slider);
    newSlider.init();
  });
};
...
var Slider = /*#__PURE__*/function () {
  ...
  _createClass(Slider, [{
    key: "init",
    value: function init() {
      this.swiper = new Swiper(".".concat(this.slider.classList[0]), this.options);
    }
  }, {
    key: "setSliderOptions",
    value: function setSliderOptions() {
      var _this = this,
        _breakpoints;
      this.options = {
        speed: 300,
        ...
        on: {
          ...
          slideChangeTransitionEnd: function slideChangeTransitionEnd(swiper) {
            return _this.setSlideTabIndex(swiper);
          }
        },
        breakpoints: (_breakpoints = {}, _defineProperty(_breakpoints, this.Layouts.mobile.minWidth, {
          allowTouchMove: true
        }), _defineProperty(_breakpoints, this.Layouts.tablet.minWidth, {
          allowTouchMove: false
        }), _defineProperty(_breakpoints, this.Layouts.desktop.minWidth, {
          allowTouchMove: false
        }), _breakpoints)
      };
      if (this.isSliderMultiple) {
        var _this$options$breakpo;
        this.options.breakpoints = (_this$options$breakpo = {}, _defineProperty(_this$options$breakpo, this.Layouts.mobile.minWidth, {
          slidesPerView: this.Layouts.mobile.slidesPerView,
          spaceBetween: 32,
          allowTouchMove: true
        }), _defineProperty(_this$options$breakpo, this.Layouts.tablet.minWidth, {
          slidesPerView: this.Layouts.tablet.slidesPerView,
          spaceBetween: 30,
          allowTouchMove: false
        }), _defineProperty(_this$options$breakpo, this.Layouts.desktop.minWidth, {
          slidesPerView: this.Layouts.desktop.slidesPerView,
          spaceBetween: 40,
          allowTouchMove: false
        }), _this$options$breakpo);
    ...
    value: function updateButtonVisibility() {
      var layoutType = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.options;
    ...
    key: "setSlideTabIndex",
    value: function setSlideTabIndex() {
      var swiper = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.swiper;
      if (!this.isLockFocus) {
        return;
      }
      var sliderLeftCoordinate = this.slider.getBoundingClientRect().left;
      var sliderRightCoordinate = this.slider.getBoundingClientRect().right;
      swiper.slides.forEach(function (slide) {
        var slideLeftCoordinate = slide.getBoundingClientRect().left;
        var slideRightCoordinate = slide.getBoundingClientRect().right;
    ...
    value: function debounce(callback) {
      var _this2 = this;
      var timeoutDelay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 300;
      var timeoutId;
      return function () {
        ...
        timeoutId = setTimeout(function () {
          return callback.apply(_this2, rest);
        }, timeoutDelay);
      };
    }
  }]);
...
var Video = /*#__PURE__*/function () {
  ...
  _createClass(Video, [{
    ...
    value: function playButtonClickHandler(evt) {
    ...
    value: function initPlayer() {
      ...
      window.onYouTubePlayerAPIReady = function () {
        _this.youtubePlayer = new YT.Player(_this.video.id, {
          videoId: _this.video.id,
          events: {
            'onReady': _this.enablePlayButton.bind(_this),
            'onStateChange': _this.putPlayButtonBack.bind(_this)
          }
        });
      };
    }
  }, {
    key: "putPlayButtonBack",
    value: function putPlayButtonBack(event) {
      if (event.data === 0) {
    ...
    key: "loadScript",
    value: function loadScript(src, handleLoad) {
