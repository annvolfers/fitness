...
/* harmony import */ var _modules_slider_init_sliders__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/slider/init-sliders */ "./js/modules/slider/init-sliders.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    var video = new _modules_video_video__WEBPACK_IMPORTED_MODULE_3__["Video"]();
    video.init();
    var tabs = new _modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_4__["Tabs"]();
    window.tabs = tabs;
    Object(_modules_slider_init_sliders__WEBPACK_IMPORTED_MODULE_5__["initSliders"])();
  ...
  _createClass(Slider, [{
    ...
    value: function setSliderOptions() {
      this.options = {
        ...
        breakpoints: _defineProperty({}, this.Layouts.mobile.minWidth, {
          allowTouchMove: true
        })
      };
    ...
    key: "updateButtonAvailability",
    value: function updateButtonAvailability(layoutType) {
